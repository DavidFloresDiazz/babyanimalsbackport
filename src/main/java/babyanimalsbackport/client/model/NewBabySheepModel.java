...
public class NewBabySheepModel extends SheepModel<NewBabySheep> {

    public NewBabySheepModel(final ModelPart root) {
        super(root);
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild("head", CubeListBuilder.create()
                        .texOffs(0, 0)
                        .addBox(-2.5F, 5F, -3.5F, 5.0F, 5.0F, 5.0F),
                PartPose.offset(0.0F, 15.5F, -2.5F));


        root.addOrReplaceChild("body", CubeListBuilder.create()
                .texOffs(0, 10)
                .addBox(-3.0F, -2.0F, -4.5F, 6.0F, 4.0F, 9.0F),
        ...
        root.addOrReplaceChild(
                ...
                PartPose.offset(-2.0F, 19.0F, 3.0F)
        );
